                ...
                <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-xl ligth:bg-slate-850 ligth:shadow-ligth-xl rounded-2xl bg-clip-border">
                    <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        ...
                        <div class="flex flex-wrap items-center justify-between">
                            ...
                            <a href="<?= base_url("admin/add_compromise"); ?>" class="inline-block px-4 py-2.5 bg-blue-400 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-500 hover:shadow-lg focus:bg-blue-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-600 active:shadow-lg transition duration-150 ease-in-out">
                                <i class="fa-solid fa-plus"></i>
                                <span class="ml-1 hidden sm:inline">Agregar Compromiso</span>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="block md:hidden px-4" id="cards">
                            ...
                            <div class="card-item bg-white border border-gray-200 rounded-lg shadow-md p-4 mb-4 uppercase">
                                <div class="flex justify-between items-start">
                                    ...
                                    <a href="<?= base_url("admin/edit_compromise/{$compromise['compromise_id']}") ?>" title="Editar compromiso" class="inline-block px-2 py-1.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 flex-shrink-0">
                                        <i class="fa-solid fa-pencil"></i>
                                    </a>
                                </div>
                                <hr class="my-2">
                                <p class="mb-0 text-xs font-semibold leading-tight normal-case text-slate-600">
                                    <?= substr($compromise['compromise_description'], 0, 150) . (strlen($compromise['compromise_description']) > 150 ? "..." : "") ?>
                                </p>
                            </div>
                            <?php endforeach; ?>
                        </div>
