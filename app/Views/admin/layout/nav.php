...
<!-- sidenav  -->
<aside class="fixed inset-y-0 flex-wrap items-center justify-between block w-full p-0 my-4 overflow-y-auto antialiased transition-transform duration-200 -translate-x-full bg-white border-0 shadow-xl Light:shadow-none Light:bg-slate-850 max-w-64 ease-nav-brand z-990 xl:ml-6 rounded-2xl xl:left-0 xl:translate-x-0" id="sidenav-main" aria-expanded="false">
    <div class="h-19">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap Light:text-white text-slate-700" href="<?= base_url('admin/dashboard') ?>">
            
        <img src="<?= base_url('img/LOGOTIPO_FUNDACION_KALLPA.png')?>" class="inline h-full max-w-full transition-all duration-200 Light:inline ease-nav-brand max-h-8" alt="main_logo" />
                        ...
                        <ul class="flex flex-col pl-0 mb-0">
                            ...
                            <li class="mt-0.2 w-full">
                                <a class=" Light:text-white Light:o<pacity-80 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors <?= service('request')->uri->getPath() == 'admin/questionnaires' ? 'rounded-lg font-semibold text-slate-700  bg-blue-500/13':'' ?>" href="<?= base_url('admin/questionnaires') ?>">
                                    ...
                                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Cuestionarios</span>
                                </a>
                            </li>
                            ...
                            <li class="mt-0.2 w-full">
                                <a class=" Light:text-white Light:o<pacity-80 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors <?= service('request')->uri->getPath() == 'admin/financiers' ? 'rounded-lg font-semibold text-slate-700  bg-blue-500/13':'' ?>" href="<?= base_url('admin/financiers') ?>">
                                    <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                                        <i class="relative top-0 text-sm leading-normal text-cyan-500 fa-solid fa-notes-medical"></i>
                                    </div>
                                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Financiadores</span>
                                </a>
                            </li>
                            <li class="mt-0.2 w-full">
