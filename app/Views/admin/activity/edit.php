                    ...
                    <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <div class="relative">
                            <div class="absolute left-0 top-0">
                                <h6 class="ligth:text-white text-xl">Editar actividad</h6>
                            </div>
                        </div>
                    </div>
                    <div class="flex-auto px-0 pt-0 pb-2 mt-8">
                        <div class="overflow-x-auto ml-4 pr-8 pl-4 pt-4">
                            <form class="w-full"  action="<?= base_url('admin/update_activity') ?>" method="POST" enctype="multipart/form-data">
                                <?= $this->include('admin/activity/form') ?>
                            </form>
                        </div>
                    </div>
                </div>
