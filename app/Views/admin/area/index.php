                ...
                <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-xl ligth:bg-slate-850 ligth:shadow-ligth-xl rounded-2xl bg-clip-border">
                    <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        ...
                        <div class="flex flex-wrap items-center justify-between">
                            <h6 class="ligth:text-white text-xl">Áreas: <?= count($areas) ?></h6>
                            <a href="<?= base_url("admin/add_area"); ?>" class="inline-block px-4 py-2.5 bg-blue-400 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-500 hover:shadow-lg focus:bg-blue-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-600 active:shadow-lg transition duration-150 ease-in-out">
                                <i class="fa-solid fa-plus"></i>
                                <span class="ml-1 hidden sm:inline">Agregar Área</span>
                            </a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr class="uppercase">
                                        <td class="p-2 align-middle bg-transparent border-b ligth:border-white/40 whitespace-nowrap shadow-transparent">
                                            <h6 class="px-4 mb-0 text-sm leading-normal ligth:text-white"><?= $area['area_name'] ?></h6>
                                        </td>
                                        <td class="p-2 align-middle bg-transparent border-b ligth:border-white/40 whitespace-nowrap shadow-transparent">
                                            <p class="mb-0 text-xs font-semibold leading-tight ligth:text-white ligth:opacity-80 normal-case"><?= $area['area_description'] ?></p>
                                        </td>
                                        <td class="p-2 text-sm leading-normal text-center align-middle bg-transparent border-b ligth:border-white/40 whitespace-nowrap shadow-transparent">
                                            <span class="bg-gradient-to-tl <?= $area['status_name'] == 'Activo' ? 'from-emerald-500 to-teal-400' : 'from-slate-600 to-slate-300' ?> px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">
                                                <?= $area['status_name'] ?>
                                            </span>
                                        </td>
                                        <td class="p-2 align-middle bg-transparent border-b ligth:border-white/40 whitespace-nowrap shadow-transparent">
                                            <a href="<?= base_url("admin/edit_area/{$area['area_id']}") ?>" title="Editar Área" class="text-xs font-semibold leading-tight text-slate-400">
                        ...
                        <div class="block md:hidden px-4" id="cards">
                            ...
                            <div class="card-item bg-white border border-gray-200 rounded-lg shadow-md p-4 mb-4 uppercase">
                                <div class="flex justify-between items-start">
                                    <h6 class="mb-1 text-sm font-bold leading-normal ligth:text-white"><?= $area['area_name'] ?></h6>
                                    <a href="<?= base_url("admin/edit_area/{$area['area_id']}") ?>" title="Editar Área" class="inline-block px-2 py-1.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700">
                                        <i class="fa-solid fa-pencil"></i>
                                    </a>
                                </div>
                                <p class="mb-2 text-xs font-semibold leading-tight normal-case text-slate-600"><?= $area['area_description'] ?></p>
                                <span class="bg-gradient-to-tl <?= $area['status_name'] == 'Activo' ? 'from-emerald-500 to-teal-400' : 'from-slate-600 to-slate-300' ?> px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">
                                    <?= $area['status_name'] ?>
                                </span>
                            </div>
